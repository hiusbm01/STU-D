            ...
            <form onSubmit={handleSignupSubmit}>
                ...
                <div className="form-floating mb-2">
                    <input type="password" className="form-control" id="floatingPassword"
                           placeholder="Password" vlaue={password} onChange={(e) => setPassword(e.target.value)} required
                    />
                ...
                <div className="form-floating mb-2">
                    <input type="phoneNumber" className="form-control" id="floatingPhone"
                           placeholder="010-1234-1234" vlaue={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} 
                    />
